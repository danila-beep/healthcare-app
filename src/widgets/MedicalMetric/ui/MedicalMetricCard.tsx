...
export const MedicalMetricCard = ({ metric }: { metric: IHealthMetric }) => {
  return (
    <li className="bg-white rounded-2xl p-4 shadow-md cursor-pointer hover:shadow-lg transition-all duration-200">
